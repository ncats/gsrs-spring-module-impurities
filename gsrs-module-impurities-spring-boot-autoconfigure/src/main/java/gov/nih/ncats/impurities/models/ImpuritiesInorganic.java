...
@Data
@Entity
@Table(name="SRSCID_IMPURITIES_INORGANIC", schema = "srscid")
public class ImpuritiesInorganic extends AbstractGsrsEntity {

    @Id
    @SequenceGenerator(name = "impInorgSeq", sequenceName = "SRSCID.SRSCID_SQ_IMPURITIES_INORG_ID", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "impInorgSeq")
    @Column(name = "ID")
    public Long id;
