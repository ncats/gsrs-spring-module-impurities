...
@Data
@Entity
@Table(name="SRSCID_IMPURITIES_IDENTITY", schema = "srscid")
public class ImpuritiesIdentityCriteria extends AbstractGsrsEntity {

    @Id
    @SequenceGenerator(name = "impIdentSeq", sequenceName = "SRSCID.SRSCID_SQ_IMPURITIES_IDENT_ID", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "impIdentSeq")
    @Column(name = "ID")
    public Long id;
