package gov.hhs.gsrs.impurities.validators;
    ...
    public void validate(Impurities objnew, Impurities objold, ValidatorCallback callback) {
        if (objnew.impuritiesSubstanceList.isEmpty()) {
            GinasProcessingMessage mes = GinasProcessingMessage
                    .ERROR_MESSAGE("RequiredFieldNonNullValidatorError1","Must have at least one Substance");
        ...
        while(iter.hasNext()) {
            ...
            if (s.substanceUuid == null) {
                callback.addMessage(GinasProcessingMessage
                        .ERROR_MESSAGE("RequiredFieldNonNullValidatorError2","Substance Name is required"));
            }
