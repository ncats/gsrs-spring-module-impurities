...
@EnableJpaRepositories(
        entityManagerFactoryRef = ImpuritiesDataSourceConfig.NAME_ENTITY_MANAGER,
        transactionManagerRef = ImpuritiesDataSourceConfig.NAME_TRANSACTION_MANAGER,
        basePackages = {"gov.hhs.gsrs.impurities"}
)
@Slf4j
public class ImpuritiesDataSourceConfig extends GSRSDataSourceConfig {
    ...
    protected static final String[] BASE_PACKAGES = new String[] {"gov.hhs.gsrs.impurities"};
    protected static final String PERSIST_UNIT = "impurities";
  //  protected static final String DATASOURCE_PROPERTY_PATH_PREFIX = "spring";
   ...
   // @Primary
    public LocalContainerEntityManagerFactoryBean getProductEntityManager(EntityManagerFactoryBuilder builder,
