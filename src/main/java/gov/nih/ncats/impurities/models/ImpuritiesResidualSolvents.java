...
@Data
@Entity
@Table(name="SRSCID_IMPURITIES_RESIDUAL", schema = "srscid")
public class ImpuritiesResidualSolvents extends AbstractGsrsEntity {

    @Id
    @SequenceGenerator(name = "impResSeq", sequenceName = "SRSCID.SRSCID_SQ_IMPURITIES_RESIDU_ID", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "impResSeq")
    @Column(name = "ID")
    public Long id;
