...
@Data
@Entity
@Table(name="SRSCID_IMPURITIES_TEST", schema = "srscid")
public class ImpuritiesTesting extends AbstractGsrsEntity {

    @Id
    @SequenceGenerator(name = "impTestSeq", sequenceName = "SRSCID.SRSCID_SQ_IMPURITIES_TEST_ID", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "impTestSeq")
    @Column(name = "ID")
    public Long id;
