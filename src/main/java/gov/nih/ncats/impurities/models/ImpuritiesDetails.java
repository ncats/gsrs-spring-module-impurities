...
@Data
@Entity
@Table(name="SRSCID_IMPURITIES_DETAILS", schema = "srscid")
public class ImpuritiesDetails extends AbstractGsrsEntity {

    @Id
    @SequenceGenerator(name = "impDetSeq", sequenceName = "SRSCID.SRSCID_SQ_IMPURITIES_DETAIL_ID", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "impDetSeq")
    @Column(name = "ID")
    public Long id;
